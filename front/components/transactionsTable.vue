...
<div class="flex flex-col bg-white rounded-3xl p-6 h-full items-center justify-center max-h-72">
    <table class="bg-white rounded-3xl w-full h-full table-auto flex flex-col justify-between items-center"> 
        <thead class="border-b border-gray-100 w-full pb-4">
            ...
            <TransactionsHead class="text-start w-full xs:hidden md:block">Type</TransactionsHead>
            ...
            <TransactionsHead class="text-start w-full md:block xs:hidden">État</TransactionsHead>
            </tr>
        </thead>
        <tbody class="flex flex-col gap-4 justify-between items-center w-full h-full">
            ...
            >
                ...
                >
                    <TransactionsRow class="text-start w-full xs:hidden md:block">
                        <Icones v-if="sale.type == 'Vente'" icon="hand-holding-dollar" color="green" />
                        <Icones v-else icon="arrow-right-arrow-left" color="red" />
                    </TransactionsRow>
